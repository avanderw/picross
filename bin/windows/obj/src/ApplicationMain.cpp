...
HX_LOCAL_STACK_FRAME(_hx_pos_b3b993f62d801895_228___init__,"::ApplicationMain_obj","__init__",0x253d991d,"::ApplicationMain_obj.__init__","ApplicationMain.hx",228,0x0780ded5)
...
HX_LOCAL_STACK_FRAME(_hx_pos_6fcf922b66429816_96_create,"ApplicationMain","create",0x2f7db141,"ApplicationMain.create","ApplicationMain.hx",96,0x0780ded5)
...
HX_LOCAL_STACK_FRAME(_hx_pos_6fcf922b66429816_129_start,"ApplicationMain","start",0x45b5d9bd,"ApplicationMain.start","ApplicationMain.hx",129,0x0780ded5)
...
void ApplicationMain_obj::__init__(){
            	HX_STACKFRAME(&_hx_pos_b3b993f62d801895_228___init__)
HXDLIN( 228)		 ::Dynamic init = hx::ClassOf< ::lime::app::Application >();
            	}


void ApplicationMain_obj::main(){
            	HX_STACKFRAME(&_hx_pos_6fcf922b66429816_21_main)
HXLINE(  23)		::String projectName = HX_("picross",e7,36,37,79);
HXLINE(  25)		 ::Dynamic config =  ::Dynamic(hx::Anon_obj::Create(9)
            			->setFixed(0,HX_("company",3d,15,69,83),HX_("Andrew van der Westhuizen",75,e5,ba,35))
            			->setFixed(1,HX_("build",2e,db,ea,ba),HX_("30",9d,2c,00,00))
            			->setFixed(2,HX_("windows",83,de,74,e8),::Array_obj< ::Dynamic>::__new(1)->init(0, ::Dynamic(hx::Anon_obj::Create(22)
            				...
            				->setFixed(10,HX_("title",98,15,3b,10),HX_("picross",e7,36,37,79))
            			...
            			->setFixed(5,HX_("packageName",f1,04,ad,04),HX_("picross",e7,36,37,79))
            			->setFixed(6,HX_("file",7c,ce,bb,43),HX_("picross",e7,36,37,79))
            			->setFixed(7,HX_("name",4b,72,ff,48),HX_("picross",e7,36,37,79))
...
HXLINE(  80)		::ApplicationMain_obj::create(config);
            	}
...
void ApplicationMain_obj::create( ::Dynamic config){
            		...
            		void _hx_run(){
            			HX_GC_STACKFRAME(&_hx_pos_6fcf922b66429816_96_create)
HXLINE(  96)			::ApplicationMain_obj::start(a1);
            		}
...
HXLINE(  89)		app->create(config);
HXLINE(  91)		::ManifestResources_obj::init(config);
HXLINE(  93)		 ::openfl::display::Preloader preloader =  ::openfl::display::Preloader_obj::__alloc( HX_CTX , ::openfl::display::DefaultPreloader_obj::__alloc( HX_CTX ));
HXLINE(  94)		app->setPreloader(preloader);
HXLINE(  95)		preloader->create(config);
HXLINE(  96)		 ::openfl::display::Stage a1 = app->_hx___windows->__get((int)0).StaticCast<  ::lime::ui::Window >()->stage;
HXDLIN(  96)		 ::Dynamic _hx_tmp =  ::Dynamic(new _hx_Closure_0(a1));
HXDLIN(  96)		preloader->onComplete->add(_hx_tmp,null(),null());
HXLINE(  98)		{
HXLINE(  98)			int _g = (int)0;
HXDLIN(  98)			::Array< ::Dynamic> _g1 = ::ManifestResources_obj::preloadLibraries;
HXDLIN(  98)			while((_g < _g1->length)){
HXLINE(  98)				 ::lime::utils::AssetLibrary library = _g1->__get(_g).StaticCast<  ::lime::utils::AssetLibrary >();
HXDLIN(  98)				_g = (_g + (int)1);
HXLINE( 100)				preloader->addLibrary(library);
            			}
            		}
HXLINE( 104)		{
HXLINE( 104)			int _g2 = (int)0;
HXDLIN( 104)			::Array< ::String > _g11 = ::ManifestResources_obj::preloadLibraryNames;
HXDLIN( 104)			while((_g2 < _g11->length)){
HXLINE( 104)				::String name = _g11->__get(_g2);
HXDLIN( 104)				_g2 = (_g2 + (int)1);
HXLINE( 106)				preloader->addLibraryName(name);
            			}
            		}
HXLINE( 110)		preloader->load();
HXLINE( 112)		int result = app->exec();
HXLINE( 115)		::lime::_hx_system::System_obj::exit(result);
            	}
...
void ApplicationMain_obj::start( ::openfl::display::Stage stage){
            	HX_GC_STACKFRAME(&_hx_pos_6fcf922b66429816_129_start)
HXDLIN( 129)		try {
            			HX_STACK_CATCHABLE( ::Dynamic, 0);
HXLINE( 184)			{
HXLINE( 186)				 ::openfl::display::DisplayObject current = stage->getChildAt((int)0);
HXLINE( 188)				bool _hx_tmp;
HXDLIN( 188)				if (hx::IsNotNull( current )) {
HXLINE( 188)					_hx_tmp = !(::Std_obj::is(current,hx::ClassOf< ::openfl::display::DisplayObjectContainer >()));
            				}
            				else {
HXLINE( 188)					_hx_tmp = true;
            				}
HXDLIN( 188)				if (_hx_tmp) {
HXLINE( 190)					current =  ::openfl::display::MovieClip_obj::__alloc( HX_CTX );
HXLINE( 191)					stage->addChild(current);
            				}
HXLINE( 195)				 ::DocumentClass_obj::__alloc( HX_CTX ,( ( ::openfl::display::DisplayObjectContainer)(current) ));
            			}
HXLINE( 133)			stage->dispatchEvent( ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("resize",f4,59,7b,08),false,false));
HXLINE( 135)			if (stage->window->_hx___fullscreen) {
HXLINE( 137)				stage->dispatchEvent( ::openfl::events::FullScreenEvent_obj::__alloc( HX_CTX ,HX_("fullScreen",5b,ae,48,2e),false,false,true,true));
            			}
            		}
            		catch( ::Dynamic _hx_e){
            			if (_hx_e.IsClass<  ::Dynamic >() ){
            				HX_STACK_BEGIN_CATCH
            				 ::Dynamic e = _hx_e;
HXLINE( 144)				stage->_hx___handleError(e);
            			}
            			else {

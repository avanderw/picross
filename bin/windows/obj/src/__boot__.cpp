...
::openfl::_internal::renderer::dom::DOMBlendModeManager_obj::__register();
...
::openfl::_Vector::AbstractVector_obj::__register();
...
::openfl::_internal::renderer::opengl::GLMaskManager_obj::__boot();
